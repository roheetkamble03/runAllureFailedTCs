...
public class ManuallyDownloadZipAndReadTheTestCases {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while(!isZipFileProcessed) {
            try {
                //In case downloading not working
                ZipFile zipFile = new ZipFile(new File("src/tempAllureReportZipFile.zip"));
